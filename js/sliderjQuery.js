...
Slider.prototype.addEvent = function(){
	...
	this.$box1.mouseover(function(){
		that.stop();
	});
	
	this.$box1.mouseout(function(){
		if(that.isAutoPlay){
			that.autoPlay();	
		}	
	});
	
	let $li = $(this.$box1.selector+" ul").children();
	$li.click(function(){
...
Slider.prototype.showImg=function(outIndex,inIndex){
	//3、改变外观
	//1)、改图片
	let $img =this.$box1.children("img");
